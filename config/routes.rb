ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :users, :collection => {:resend_activation_email => :get, :send_activation_email => :post, :change_email => :get, :change_password => :get, :avatar => :get, :show_welcome_dialog => :put}, :except => [:new]
